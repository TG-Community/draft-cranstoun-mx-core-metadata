...
- [Editor's Copy](https://TG-Community.github.io/draft-cranstoun-mx-core-metadata/)
- [Stream Draft Record](https://stream.tg.community/doc/draft-cranstoun-mx-core-metadata)
- [Latest Release](https://github.com/TG-Community/draft-cranstoun-mx-core-metadata/releases/latest)
...
4. In **Tag**, create a release tag for this publication.
   Use `draft-cranstoun-mx-core-metadata-00` for the first published version.
   Use `draft-cranstoun-mx-core-metadata-01`, `draft-cranstoun-mx-core-metadata-02`, and so on for later versions.
